package tropichopper.common.command;
...
public class TCHCommand extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (sender.canUseCommand(this.getRequiredPermissionLevel(), this.getName())) {
            if (args.length < 1) {
                ...
                TropiChopper.m_Network.sendToAll(new ClientSettingsMessage(ConfigurationHandler.reverseShift, ConfigurationHandler.disableShift));
                ...
                TropiChopper.m_Network.sendToAll(new ClientSettingsMessage(ConfigurationHandler.disableShift, ConfigurationHandler.disableShift));
    ...
    private void GetUsage(ICommandSender sender) {
        sender.sendMessage(new TextComponentTranslation(TextFormatting.GOLD + "Tropi Chopper"));
        ...
        sender.sendMessage(new TextComponentTranslation(TextFormatting.AQUA + "/tch decLeaves" + TextFormatting.RESET + " 0/1 -" + TextFormatting.ITALIC + GetTranslatedText(sender, "command.decayLeavesInfo", " Decay leaves with tropi fall")));
