package tropichopper.common.config;
...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration() {
        try {
            decayLeaves = config.getBoolean("Decay leaves", "Settings", true, "Cut down whole tropi - wooden blocks and leaves");
            reverseShift = config.getBoolean("Reverse shift", "Settings", false, "Reverse shift function - Mod works with shift pressing");
            disableShift = config.getBoolean("Disable shift", "Settings", false, "Disable shift function - Always chop tropis regardless of shift pressing");
            plantSapling = config.getBoolean("Plant sapling", "Settings", false, "Automatic sapling plant on tropi chop");
            ...
            System.out.printf("Cannot load Tropi Chopper config.");
        } finally {
    ...
    public static void setPlantSap(boolean plantSap) {
        ...
        config.get("Settings", "Plant sapling", false, "Automatic sapling plant on tropi chop").set(plantSap);
    ...
    public static void setDisableShi(boolean disableShi) {
        ...
        config.get("Setting", "Disable shift", false, "Disable shift function - Always chop tropis regardless of shift pressing").set(disableShi);
    ...
    public static void setDecayLea(boolean decayLea) {
        ...
        config.get("Settings", "Decay leaves", true, "Cut down whole tropi - wooden blocks and leaves").set(decayLea);
    ...
    public void onConfigurationChangedEvent(ConfigChangedEvent.OnConfigChangedEvent event) {
        if (event.getModID().equalsIgnoreCase(TropiChopper.MOD_ID)) {
            loadConfiguration();
        }
    }
}
